...
var uploadImage = function (req, res) {
    config.upload(req, res, function (err) {
        if (err) {
            ...
            var images = req.files.map(function (file) {
                return {
...
var getImage = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var doc, imageURL, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, image_model_1.default.findOne({ _id: req.params.id }).lean().exec()];
            case 1:
                doc = _a.sent();
                if (!doc) {
                    res.status(404).json({ req: req.params.id });
                }
                imageURL = path_1.default.join(config.uploadDir, doc.generatedFileName);
